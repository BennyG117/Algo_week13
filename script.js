...
//1st node of our item in a data structure is a "head" and the last is a "tail"
//one direction only!
...
class ListNode {
  ...
  class SinglyLinkedList {
    ...
    insertAtBack(value) {
      ...
      //return needed to chain and run code...
      return this;
    }
...
// myList.insertAtBack(1).insertAtBack(2).insertAtBack(3);

//!incomplete attempt
// const myNode = new List(); 

          // if(!this.isEmpty()){
          //   return this.push(myNode);
          // } else {
          //   const myList = new SinglyLinkedList();
          // myList.push(data);
          // return myList;
